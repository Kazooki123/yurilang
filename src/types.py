...
def type_name(value):
    ...
    if isinstance(value, bool):     return "bloom"
    if isinstance(value, int):      return "int"
    if isinstance(value, float):    return "float"
    if isinstance(value, str):      return "heart"
    if isinstance(value, list):     return "list"
    if isinstance(value, dict):     return "persona"
    ...
    if crush_hints:
        ...
        if func_hints:
            ...
            for func, hints in func_hints.items():
                params = ", ".join(
                    f"{p}:{t}" for p, t in hints["params"].items()
                )
